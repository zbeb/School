...
Bio2 = float(input("Ecris tes notes d'interro de Bio: "))
Bio3 = float(input("Ecris tes notes d'interro de Bio: "))
Geo1 = float(input("Ecris tes notes d'interro de Geo: "))
Geo2 = float(input("Ecris tes notes d'interro de Geo: "))
fr1 = float(input("Ecris tes notes d'interro de Fr: "))

sommeInterro = Bio1 + Bio2 + Bio3 + Geo1 + Geo2 + fr1
